...
import static com.kt.basic.vendingmachine.VendingMachineMain.*;
...
public class VendingMachine{
	...
	static void vendingview() {
		...
		System.out.println("돈을 넣고 원하시는 음료의 번호를 눌러주세요");
		System.out.println("현재잔액 " + moneyinmachine + "원");

	}

	int calculate(int pick) {
		int restmoney = money - Drink.prices[pick];
